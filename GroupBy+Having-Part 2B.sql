...
SELECT job_id, AVG(salary) AS avg_salary FROM employee GROUP BY job_id HAVING avg_salary>10000 ORDER BY avg_salary DESC;
...
SELECT job_id, AVG(salary) AS avg_salary FROM employee GROUP BY job_id HAVING avg_salary>=10000 AND avg_salary<=20000 ORDER BY avg_salary DESC;
